...
We also did a profiling run to the train_model script and the results can be seen in the folder ./profiling in both files profiling_time.txt and profiling_calls.txt. ---
